...
const Subscribe: React.FC = () => {
  ...
  return (
    <section className="space-y-20 w-3/4 mx-auto">
      {/* Section for the subscription title */}
      <section className="w-full flex items-center justify-center">
        <h2 className={`w-full md:w-3/4 text-center ${titleStyle}`}>
          {subscribe?.title}
        </h2>
      </section>
      ...
      <section className="flex items-center relative w-full">
        <input
          type="email"
          className="pl-16 h-20 w-full bg-white rounded-full placeholder:text-black placeholder:capitalize font-medium border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
